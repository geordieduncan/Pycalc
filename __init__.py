"""
empty__init__.py file to make computer see this as a module
...
print "     Polynomials"
print ''
print 'To access a function within a file, use: pycalc.File.function(...)'
...
print '"x**2+2*x-1"'
print 'To access help for any file use: pycalc.File.help()'
print 'For questions about graphing use pyclac.graphHelp()'
